...
class qa_conv_dec(gr_unittest.TestCase):
    ...
    Modifies the written stream by flipping 1 bit in random position. 
    ...
    def test_001_conv_dec(self):
        ...
        corrupted_message = self.flip_bits(encoded_message, 1)
    ...
    """
    This function tests the functionality of the convolutional decoder block by flipping 2 bits in random positions. 
    """
