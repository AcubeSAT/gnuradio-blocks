...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "GMSK Precoding")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GMSK Precoding")
        ...
        # Blocks
        ##################################################
        self.blocks_vector_source_x_0 = blocks.vector_source_b((1, 2, 3, 4), True, 1, [])
        ...
        self.a3sat_gmsk_precoder_0 = a3sat.gmsk_precoder()
        ...
        # Connections
        ##################################################
        self.connect((self.a3sat_gmsk_precoder_0, 0), (self.blocks_vector_sink_x_0, 0))
        self.connect((self.blocks_packed_to_unpacked_xx_0, 0), (self.a3sat_gmsk_precoder_0, 0))
