...
class bch_pdu_enc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "bch_pdu_enc")
        ...
        # Connections
        ##################################################
        self.msg_connect((self.a3sat_bch_pdu_encoder_0, 'pdu'), (self.satnogs_multi_format_msg_sink_0, 'in'))
        self.msg_connect((self.satnogs_debug_msg_source_raw_0, 'msg'), (self.a3sat_bch_pdu_encoder_0, 'acquisition'))
        self.msg_connect((self.satnogs_debug_msg_source_raw_1, 'msg'), (self.a3sat_bch_pdu_encoder_0, 'idle'))
...
def main(top_block_cls=bch_pdu_enc, options=None):
