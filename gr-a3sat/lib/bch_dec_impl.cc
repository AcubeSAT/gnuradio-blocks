  ...
  namespace a3sat {
    ...
    bch_dec::make()
    {
      return gnuradio::get_initial_sptr
              (new bch_dec_impl(56, 64));
    }

    bch_dec_impl::bch_dec_impl(unsigned int k, unsigned int n)
      : gr::block("bch_dec",
              ...
              gr::io_signature::make(1, 1, sizeof(uint8_t)))
    {
        ...
        this->n_bch = n;
        syndromes_hash = {
                {98, 0}, {49, 1}, {122, 2}, {61, 3}, {124, 4}, {62, 5}, {31, 6},
                {109, 7}, {84, 8}, {42, 9}, {21, 10}, {104, 11}, {52, 12},
                {26, 13}, {13, 14}, {100, 15}, {50, 16}, {25,17}, {110,18},
                {55,19}, {121,20}, {94,21}, {47,22}, {117,23}, {88,24}, {44,25},
                {22,26}, {11, 27}, {103, 28}, {81, 29}, {74, 30}, {37, 31},
                {112, 32}, {56, 33}, {28, 34}, {14, 35}, {7, 36}, {97, 37},
                {82, 38}, {41, 39}, {118, 40}, {59, 41}, {127, 42}, {93, 43},
                {76, 44}, {38, 45}, {19, 46}, {107, 47}, {87, 48}, {73, 49}, {70, 50},
                {35, 51}, {115, 52}, {91, 53}, {79, 54}, {69, 55}, {64, 56},
                {32, 57}, {16, 58}, {8, 59}, {4, 60}, {2, 61}, {1, 62}
    ...
    bch_dec_impl::general_work (int noutput_items,
        ...
        int primitive_elements_bch_63_54[64] = {1, 2, 4, 8, 16, 32, 64, 69, 79, 91, 115, 35, 70, 73, 87, 107,
      ...
      int bch_dec_impl::get_k_bch() { return k_bch; }
